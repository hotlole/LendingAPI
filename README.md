...
⚠️ Обрати внимание: это может повлиять на данные при удалении сущностей. В проде рекомендуется использовать Restrict или SetNull, если есть риски потери важной информации.
