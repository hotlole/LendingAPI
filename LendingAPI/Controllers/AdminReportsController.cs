...
{
    /// <summary>
    /// Контроллер для генерации отчетов для администратора.
    /// </summary>
    [ApiController]
    ...
    public class AdminReportsController : ControllerBase
    {
        ...
        /// <summary>
        /// Конструктор контроллера для отчетов администратора.
        /// </summary>
        ...
        /// <summary>
        /// Генерация месячного отчета по пользователям и их посещениям мероприятий.
        /// </summary>
        /// <param name="month">Месяц для отчета (1-12)</param>
        /// <param name="year">Год для отчета</param>
        /// <returns>Excel-файл с отчетом</returns>
        ...
        public async Task<IActionResult> GenerateMonthlyReport([FromQuery] int month, [FromQuery] int year)
        {
            ...
            // Заголовки: первая строка — мероприятия
